...
class FilesystemStorage implements FilesystemStorageInterface, StorageAdapterInterface
{
     ...
     */
    protected $projectDir, ViewcounterConfig $viewcounterConfig, FileStatsBuilder $fileStatsBuilder)
    {
    ...
    public function getFullStatsFileName(): string
    {
        ...
        return $this->getViewcounterDir() . 'FilesystemStorage.php/' . $this->getStatsFileName() . $extension;
    }
