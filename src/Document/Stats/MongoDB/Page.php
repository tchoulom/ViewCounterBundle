...
#[MongoDB\Document(collection: 'page', repositoryClass: \Tchoulom\ViewCounterBundle\Repository\Stats\MongoDB\PageRepository::class)]
...
class Page
{
    ...
    #[MongoDb\ReferenceMany(targetDocument: \Tchoulom\ViewCounterBundle\Document\Stats\MongoDB\Year::class, mappedBy: 'page', cascade: ['persist', 'remove'])]
    protected $years;

    #[MongoDb\ReferenceMany(targetDocument: \Tchoulom\ViewCounterBundle\Document\Stats\MongoDB\PageCountry::class, mappedBy: 'page')]
    protected $pageCountries;

    #[MongoDb\ReferenceMany(targetDocument: \Tchoulom\ViewCounterBundle\Document\Stats\MongoDB\PageContinent::class, mappedBy: 'page')]
