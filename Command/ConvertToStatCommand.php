...
/**
 * Class ConvertToStatCommand
 *
 * @package Tchoulom\ViewCounterBundle\Command
 */
class ConvertToStatCommand extends AbstractCommand
{
    /**
    ...
    {
        $this
            ->setName('tchoulom:viewcounter:convert-to-stats')
            ->setDescription(
     ...
     * @throws \Exception
     */
    protected function convertToStats(): int
    {
        ...
        if (self::CONVERT_TO_STATS_CONFIRMED === $confirmConvert) {
            ...
            if ($canConvertToStats && true === $cleanup) {
